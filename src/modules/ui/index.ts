...
const iconMarkupMap: Record<AppIconName, string> = {
  ...
  refresh:
    '<svg viewBox="0 0 1024 1024" focusable="false" aria-hidden="true"><path d="M799.86 275.54A383.8 383.8 0 0 0 511.97 144C299.87 144 128 315.87 128 527.97S299.87 912 511.97 912c169.88 0 315.9-110.37 365.98-263.77h-67.88C764.41 759.7 647.34 832 511.97 832 344.06 832 208 695.94 208 527.97S344.06 224 511.97 224c101.72 0 191.75 49.95 246.89 126.81L640 469.67h256V213.67z"></path></svg>',
  frameAdd:
